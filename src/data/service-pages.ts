...
export const servicePages: Record<string, ServicePageContent> = {
  'individual-therapy': {
    title: 'Individual Therapy in Madison, Wisconsin',
    description: 'Individual counseling with Jordan Ellis, LPC, for adults seeking thoughtful, whole-person support in Madison, Wisconsin.',
    ...
    approach: ['Jordan may draw from Internal Family Systems concepts, somatic awareness, mindfulness, and other counseling tools depending on the focus of the work.', 'Sessions may include understanding why a response developed, recognizing what keeps it going, and exploring changes that could be useful in daily life.'],
    wholePersonTitle: 'Attention to mind and body',
    wholePerson: ['Thoughts and emotions often have a physical dimension. Jordan may invite awareness of tension, breath, energy, or other body cues as useful information, always at a pace that respects your comfort.'],
  ...
  'trauma-ptsd': {
    title: 'Trauma & PTSD Therapy in Madison, Wisconsin',
    description: 'Compassionate trauma and PTSD counseling with Jordan Ellis, LPC, at Align Therapy Group in Madison, Wisconsin.',
    ...
    approach: ['Early work may focus on understanding current reactions, strengthening a sense of stability, and identifying what helps you stay connected to the present.', 'Depending on the situation, Jordan may incorporate Internal Family Systems concepts, mindfulness, or somatic awareness. The pace can be adjusted as the work develops.'],
    related: [],
    approachLinks: [
    ...
    'anxiety-stress': {
    title: 'Anxiety & Stress Therapy in Madison, Wisconsin',
    description: 'Individual counseling for anxiety, worry, stress, and overwhelm with Jordan Ellis, LPC, in Madison, Wisconsin.',
  ...
  'grief-loss': {
    title: 'Grief & Loss Counseling in Madison, Wisconsin',
    description: 'Thoughtful individual counseling for grief and significant loss at Align Therapy Group in Madison, Wisconsin.',
  ...
  'depression-emotional-disconnection': {
    title: 'Depression & Disconnection | Madison, WI',
    description: 'Counseling for low mood, emotional disconnection, and feeling stuck with Jordan Ellis, LPC, in Madison, Wisconsin.',
    ...
    approach: ['Jordan may help you look at patterns connected with withdrawal, self-criticism, exhaustion, or emotional shutdown and identify manageable ways to reconnect with what matters to you.', 'Counseling may also include attention to physical cues or protective responses. The goal is not to force positive thinking, but to understand what is happening and consider realistic next steps.'],
    related: [{ slug: 'individual-therapy', label: 'Learn more about individual therapy' }],
    approachLinks: [
      { href: '/approaches/', label: 'Explore Jordan’s therapy approaches' },
    ],
  },
  'chronic-pain-chronic-illness': {
    title: 'Chronic Pain & Illness Counseling | Madison, WI',
    description: 'Counseling for adults living with chronic pain or illness, with support for grief, adjustment, identity, stress, and relationships in Madison, Wisconsin.',
  ...
  'life-transitions': {
    title: 'Life Transitions Counseling | Madison, WI',
    description: 'Individual counseling for major changes in roles, identity, work, family, and relationships in Madison, Wisconsin.',
  ...
  'relationship-concerns': {
    title: 'Relationship Concerns | Madison, WI',
    description: 'Individual counseling for relationship patterns, communication, boundaries, and conflict with Jordan Ellis, LPC, in Madison, Wisconsin.',
    ...
    lead: ['You may be struggling in a current relationship, recovering from one that ended, or noticing similar difficulties across different relationships. Individual therapy offers space to examine your own experience without another person participating.', 'This service is individual counseling related to relationships. Jordan is not offering couples therapy through this service.'],
  ...
  'self-esteem-personal-growth': {
    title: 'Self-Esteem & Growth | Madison, WI',
    description: 'Counseling for self-esteem, values, boundaries, confidence, and personal growth in Madison, Wisconsin.',
