...
const canonicalOrigin = 'https://align-therapy-demo.example';
...
const analyticsPath = path.join(
  root,
  'public/scripts/brighter-analytics.js'
);
...
if (!fs.existsSync(analyticsPath)) {
  ...
  if (
    !/page_path:\s*pagePath\(\)/.test(analytics)
  ) {
    fail(
      'Analytics page_path is not explicitly generated by the pathname-only helper.'
    );
  }
}
