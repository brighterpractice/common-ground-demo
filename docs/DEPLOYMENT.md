...
Add `common.brightersites.app` under the Pages project's **Custom domains** settings and follow Cloudflare's DNS prompts. The site configuration, canonical URLs, sitemap, and robots file assume this production host:

`https://common.brightersites.app`
...
1. Add a Google Search Console **Domain property** for `common.brightersites.app`.
...
4. Submit `https://common.brightersites.app/sitemap.xml`.
